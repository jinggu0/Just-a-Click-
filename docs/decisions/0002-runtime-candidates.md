...
- 날짜: 2026-09-16
- 상태: 초기 후보 조사 기록. LLM은 이후 [0004](0004-llm-selection.md)에서 Qwen3-8B Q5_K_M으로, 앱 기술은 [0007](0007-app-stack.md)에서 Tauri 2 + React·TypeScript로 확정했으며 아래 후보 비교는 당시 기록이다. STT와 실제 추론 검증은 미완료
...
- 4시간 녹음의 요약 목표는 전사 완료 후 요약 실행부터 결과 저장까지 최대 120초·품질 우선으로 확정되었다. 실측 전 달성을 보장하지 않는다. 이 목표는 이후 [0006](0006-lecture-first-product-scope.md)에서 대체되었다.
